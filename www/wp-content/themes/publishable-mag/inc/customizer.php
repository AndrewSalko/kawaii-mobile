...
function publishable_lite_customize_register( $wp_customize ) {
	...
	* Theme Options
    ...
    $wp_customize->add_setting( 'publishable_lite_color_scheme', array('default'=>'#c69c6d','sanitize_callback' => 'sanitize_hex_color', ));
    ...
    $wp_customize->add_setting( 'publishable_lite_color_scheme2', array('default'=>'#1b1b1b','sanitize_callback' => 'sanitize_hex_color',));
